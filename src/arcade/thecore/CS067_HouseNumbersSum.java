 ...
 */
public class CS067_HouseNumbersSum {
    public static void main(String[] args) {
        System.out.println(solution(new int[]{4, 2, 1, 6, 0}));
    }

    static int solution(int[] inputArray) {
        return Arrays.stream(inputArray, 0, indexOfZero(inputArray)).sum();
    }
    static int indexOfZero(int[] array) {
