...
extended so far. However, you do remember the number of days you were able to ride the Metro during
...
public class CS16_MetroCard {
    ...
    static int[] solution(int lastNumberOfDays) {
        ...
        else if (lastNumberOfDays == 31) return new int[]{28, 30, 31};
        else return new int[]{31};
    }
}
